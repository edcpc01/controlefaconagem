...
function KpiNum({ label, valor, pctVal, color }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 10, color: 'var(--text-dim)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: '0.05em', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{label}</div>
      <div style={{ fontSize: 16, fontWeight: 700, color: color || 'var(--text)', lineHeight: 1.1, wordBreak: 'break-all' }}>{fmt(valor)} kg</div>
