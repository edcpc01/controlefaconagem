...
import { listarNFsEntrada, listarSaidas, gerarRelatorioPDF } from '../lib/faconagem'
  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        <div className="card-title">📄 Relatório PDF Mensal</div>
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'flex-end' }}>
          <div>
            <div style={{ fontSize: 11, color: 'var(--text-dim)', marginBottom: 4 }}>Mês</div>
            <select className="input" style={{ width: 160 }} value={mesSel} onChange={e => setMesSel(Number(e.target.value))}>
        ...
        <div style={{ fontSize: 11, color: 'var(--text-dim)', marginTop: 10 }}>
          O PDF inclui: entradas NFs, saídas do período, KPIs consolidados (%) e detalhamento por lote POY.
        </div>
      </div>
